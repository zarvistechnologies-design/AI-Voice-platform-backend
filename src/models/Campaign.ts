...
const campaignSchema = new Schema(
  {
    ...
    automaticCallbacks: { type: Boolean, required: true, default: true },
    scorecard: {
      enabled: { type: Boolean, default: true },
      connectionWeight: { type: Number, min: 0, max: 100, default: 20 },
      outcomeWeight: { type: Number, min: 0, max: 100, default: 20 },
      goalWeight: { type: Number, min: 0, max: 100, default: 40 },
      followUpWeight: { type: Number, min: 0, max: 100, default: 20 },
    },
